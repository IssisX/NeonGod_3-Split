...
import type { Bullet, Enemy, Particle, Gem, Pickup, Debris } from '../types';
...
export const Factories = {
  ...
  resetBullet: (b: Bullet) => { b.id = ''; b.x = 0; b.y = 0; b.vx = 0; b.vy = 0; b.life = 0; b.maxLife = 0; b.color = ''; b.dmg = 0; b.pierce = 0; b.homing = 0; b.size = 3; b.trail = []; b.isBeam = false; b.beamPoints = []; b.elemental = { fire: 0, ice: 0, volt: 0 }; b.active = false; b.bounce = 0; b.split = 0; b.explosive = 0; b.generation = 0; b.knockback = 0; },
  ...
  resetParticle: (p: Particle) => { p.x = 0; p.y = 0; p.vx = 0; p.vy = 0; p.life = 0; p.maxLife = 0; p.color = ''; p.size = 0; p.friction = 0.92; p.type = 'spark'; p.active = false; p.rotation = 0; p.rv = 0; p.sides = 3; p.targetX = undefined; p.targetY = undefined; },
  
  gem: () => ({ x: 0, y: 0, vx: 0, vy: 0, val: 0, life: 0, active: false }),
  resetGem: (g: Gem) => { g.x = 0; g.y = 0; g.vx = 0; g.vy = 0; g.val = 0; g.life = 0; g.active = false; },
  
  pickup: () => ({ x: 0, y: 0, vx: 0, vy: 0, type: 'heal', life: 0, active: false }),
  resetPickup: (p: Pickup) => { p.x = 0; p.y = 0; p.vx = 0; p.vy = 0; p.type = 'heal'; p.life = 0; p.active = false; },
  ...
  resetDebris: (d: Debris) => { d.id = ''; d.x = 0; d.y = 0; d.vx = 0; d.vy = 0; d.size = 0; d.color = '#555'; d.rotation = 0; d.vRot = 0; d.sides = 0; d.health = 0; d.active = false; d.type = 'scrap'; d.mass = 1; d.friction = 0.98; d.flash = 0; }
};
